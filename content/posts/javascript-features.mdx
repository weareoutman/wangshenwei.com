...
静态语言vs动态语言，就好比书面语vs口语，一个高端大气上档次，一个灵活自由接地气，各有用武之地，这里就不在编程语言之间掐架了。理解并熟练运用动态特性，可以让你在开发时更加高效。同时留意由此带来的潜在问题，可以避免你误入语言陷进。
...
这给C、Java等传统的强类型语言开发者以困惑，但对于PHP等开发者则又倍感亲切：
